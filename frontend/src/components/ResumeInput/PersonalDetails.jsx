      ...
      <div className="relative">
        <div className="flex justify-between items-center mb-1">
          ...
          <button 
            ...
            className="flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider hover:opacity-80 transition disabled:opacity-50 cursor-pointer min-h-[44px]"
